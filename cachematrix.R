...
## This is done with caching, which  uses two funcions: 
## one for creating the cache for the inversed matrix and
## one which fills the cache matrix the first time it runs and calculates the inverse
## and then skips the calculation afterwards.
##
...
## cacheSolve returns the inverse of the matrix. If the inverse has not been computed yet
